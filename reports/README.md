...
Some important information during training is logged in the Logs tab as well, although most of it can be found in the charts too. Every epoch is logged the same way as it normally gets printed out in the terminal when training a model locally.
